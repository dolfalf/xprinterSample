...
/**
 ...
 Set the width and length of label paper<br>
 SIZE m mm,n mm<br>
 Unit mm<br>
...
/**
 this command defines the label width and lenth<br>
 Set the width and height of the label paper<br>
 SIZE m ,n<br>
 Unit dot<br>
...
/**
 ...
 Set the vertical spacing of the label paper<br>
 GAP m mm,n mm<br>
 Unit mm<br>
...
/**
 this command defines the gap distance between to labels<br>
 Set the spacing of label paper<br>
 GAP m,n<br>
 Unit inch<br>
 (double) m:the gap distance between two labels<br>
 (double) n:the offset distance of the gap<br>
...
/**
 ...
 Set the height and offset position of the black mark<br>
   BLINE M,N<br>
   Unit inch<br>
...
/**
 ...
 OFFSET m<br>
 In peel mode, control the stop position of each label<br>
 Unit inch<br>
...
/**
 ...
 Define the paper output direction when printing<br>
 DIRECTION n<br>
...
/**
 ...
 Used to define the origin of the reference coordinate of the label<br>
 REFERENCE x,y<br>
...
/**
 ...
 Used to select international character set<br>
 COUNTRY n<br>
...
/**
 ...
 Control paper feeding distance, unit dot<br>
 FEED n<br>
...
/**
 ...
 Used to set the printer to feed paper, the vertical gap can not be detected, send error, stop feeding<br>
 LIMITFEED n<br>
 Unit inch<br>
